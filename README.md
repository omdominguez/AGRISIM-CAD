...
- `/ciclos/:id` — inscribir productores y agregar sus lotes (selecciona la
  parcela ya importada del KML; el área nunca se digita).
- `/productores` y `/productores/:id` — crear productores, sus fincas, y ver
  su desempeño histórico y estado de cuenta.
- `/mapa` — importar KML/KMZ con selector real de finca destino.
